...
#done
#
for COLLECTION in secret_votes # token_pairing # secret_tokens airdrop_merkle airdrop_merkle_secret cashback_stats rewards_data secret_tokens  secretswap_pairs secretswap_pools
do
	mongodump --uri mongodb+srv://$USERNAME:$PASSWORD@cluster0.dka2m.mongodb.net/$SRC_DB --collection $COLLECTION --out $COLLECTION-bsc.out --forceTableScan
